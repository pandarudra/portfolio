...
//   return (
//     <>
//       <div className="w-full h-screen overflow-auto bg-black flex flex-col items-center md:overflow-hidden gap-1">
      ...
      <div className="w-full h-screen overflow-auto bg-black flex flex-col items-center md:overflow-hidden gap-1">
        ...
        <div className="w-full h-auto flex flex-col gap-1">
          <div className="w-full h-auto">
            ...
            <div className="w-full md:w-1/3 mx-4 h-auto flex flex-col gap-1 bg-zinc-800 shadow-lg shadow-white">
              <span className="text-white text-lg font-medium p-4">
                Odisha University Of Technology And Research (Formerly CET)
              </span>
              <span className="text-white text-lg font-medium p-4">
